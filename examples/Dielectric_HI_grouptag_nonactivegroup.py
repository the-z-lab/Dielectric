...
fileprefix = 'N{}_phii{:.2f}_G{:.2f}_E{:.2f}_HI'.format(N, phi, gradient, field)
...
table_hs_HI.pair_coeff.set('pos','nonactive',func=hs_potential_BD,rmin=0.,rmax=diameter,coeff=dict(k=0,req=diameter))
